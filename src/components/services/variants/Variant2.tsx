...
import content from './content/variant2';
import type { VariantContent } from '../types';

const Variant2: React.FC<{ title: string; subtitle?: string; overrideContent?: VariantContent; }> = ({ title, subtitle, overrideContent }) => (
