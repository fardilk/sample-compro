...
import content from './content/variant7';
import type { VariantContent } from '../types';

const Variant7: React.FC<{ title: string; subtitle?: string; overrideContent?: VariantContent; }> = ({ title, subtitle, overrideContent }) => (
